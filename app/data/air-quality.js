module.exports = function getAirQuality(aqValue) {
    ...
    const lookup = {
        ...
        "7": { band: "high", advice: "Anyone experiencing discomfort such as sore eyes, cough or sore throat should consider reducing activity, particularly outdoors.", outlook: "Warm temperatures are expected to increase pollution levels to high across the UK today." },
        "8": { band: "high", advice: "Anyone experiencing discomfort such as sore eyes, cough or sore throat should consider reducing activity, particularly outdoors.", outlook: "Warm temperatures are expected to increase pollution levels to high across the UK today." },
        "9": { band: "high", advice: "Anyone experiencing discomfort such as sore eyes, cough or sore throat should consider reducing activity, particularly outdoors.", outlook: "Warm temperatures are expected to increase pollution levels to high across the UK today." },
        "10": { band: "very high", advice: "Reduce physical exertion, particularly outdoors, especially if you experience symptoms such as cough or sore throat.", outlook: "The current heatwave shows no signs of relenting, causing air pollution levels to remain very high across the UK today."}
    };
